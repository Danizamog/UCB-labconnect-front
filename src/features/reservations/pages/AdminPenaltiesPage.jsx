    ...
    <section className="reservations-page" aria-label="Panel de penalizaciones">
      <header className="reservations-header">
        <div>
          ...
          <h2>Penalizaciones por daños</h2>
      ...
      <section className="reservations-panel">
        <div className="reservations-panel-header">
          ...
          <p className="reservations-panel-subtitle">
            Cada penalización puede enlazar un reporte de daño o mantenimiento, y activa el bloqueo de nuevas reservas de inmediato.
          </p>
        </div>
      ...
      <section className="reservations-panel">
        ...
        {penalties.length === 0 ? (
          <p className="reservations-empty">Aún no hay penalizaciones registradas.</p>
        ) : (
            ...
            {penalties.map((penalty) => (
              <article key={penalty.id} className={`penalty-card${penalty.is_active ? ' is-active' : ''}`}>
                <div className="penalty-card-head">
                  <div>
                    <span className="reservation-user-card-kicker">Penalización</span>
                ...
                <div className="penalty-card-meta">
                  ...
                  <span><strong>Correo enviado:</strong> {penalty.email_sent ? 'Sí' : 'No confirmado'}</span>
                </div>
      ...
      {penaltyToLift ? (
        <ConfirmModal
          ...
          message={`El usuario ${penaltyToLift.user_name || penaltyToLift.user_id} recuperará inmediatamente la capacidad de crear nuevas reservas.`}
          confirmLabel={isLifting ? 'Procesando...' : 'Sí, levantar'}
