      ...
      {loading ? (
        ...
        <div className="infra-grid">
          ...
          <section className="infra-card infra-card-full">
            ...
            <div className="infra-search-container">
              <div className="infra-search-header">
                <span className="infra-search-title">Buscar equipo por codigo, serie o nombre</span>
                <p className="infra-search-hint">Revisa el estado actual y abre el detalle de mantenimiento y prestamos</p>
              </div>
              <label className="infra-search-input-wrapper">
                <input 
                  className="infra-search-input"
                  value={assetSearch} 
                  onChange={(event) => setAssetSearch(event.target.value)} 
                  placeholder="Ej. OSC-01, SN-2004, osciloscopio" 
                  type="search"
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="infra-status-cell">
                            ...
                            {canManageStatus ? (
                              <>
                                <small style={{ marginTop: '4px', color: 'rgba(10, 53, 89, 0.6)', fontWeight: '600' }}>Cambiar estado:</small>
