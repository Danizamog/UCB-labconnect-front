    ...
    <div className="reservation-modal-backdrop" onClick={onClose} role="dialog" aria-modal="true">
      <section className="reservation-modal penalty-modal" onClick={(event) => event.stopPropagation()}>
        <header className="reservation-modal-header">
          <div>
            <p className="reservation-modal-kicker">Penalización por daños</p>
            <h3>Registrar o documentar una suspensión</h3>
            <p>
              Vincula al usuario responsable, el reporte de evidencia y la duración del bloqueo para impedir nuevas reservas.
            </p>
          </div>
        ...
        <form className="reservation-modal-form" onSubmit={onSubmit}>
          ...
          <label>
            ...
            <textarea
              ...
              placeholder="Describe el daño, la responsabilidad y la duración del castigo."
              required
            />
          </label>
