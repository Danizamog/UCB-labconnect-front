...
export const NAVIGATION_LINKS = [
  ...
  { id: 'tutorials_history', label: 'Historial Tutorias', icon: 'history', path: '/app/tutorias/historial', userOnly: true },
  { id: 'history', label: 'Historial', icon: 'history', path: '/app/historial', userOnly: true },
