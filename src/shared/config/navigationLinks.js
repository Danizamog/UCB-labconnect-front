...
export const NAVIGATION_LINKS = [
  ...
  { id: 'analytics', label: 'Analisis', icon: 'analytics', path: '/app/admin/analisis', requiredAnyPermission: ['*', 'gestionar_reservas', 'gestionar_reglas_reserva', 'gestionar_accesos_laboratorio'] },
